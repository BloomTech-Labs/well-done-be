...
//             let history = {
//               sensor_id: data.id,
//               count: data.statuses.statuses
//                 ? data.statuses.statuses.count
//                 : null,
//               total: data.statuses.statuses
//                 ? data.statuses.statuses.total
//                 : null,
//               status: data.statuses.statuses
//                 ? data.statuses.statuses.status
//                 : null,
...
//             getStatuses(history);
//           } else {
//             console.log(`error in sensor_id: ${data.id}, no statuses property`);
//           }
//         });
//       } else {
...
//             .slice(0, 10)
//             .join("");
//           const recentFetch = res[0].created_at
//             .toString()
//             .split("")
//             .slice(0, 10)
//             .join("");
...
//                     ? data.statuses.statuses.status
//                     : null,
//                   date: data.statuses.statuses
//                     ? data.statuses.statuses.date
//                     : null,
//                   reported_percent: data.statuses.statuses
//                     ? data.statuses.statuses.reported_percent
//                     : null
...
//               } else {
//                 console.log(
//                   `error in sensor_id: ${data.id}, no statuses property`
//                 ),
//                   console.log(data);
//               }
//             });
...
//     { ...history, id: historyTbl.length + adder },
//     "id"
//   );
// }
...
//   const historyTbl = await db("history");
//   console.log(
//     "whats my history length 🚔🚔🚔🚔🚔",
//     historyTbl.length,
//     historyTbl
//   );
//   const id = historyTbl.length + 1;
//   return db("history")
...
//         let current = {
//           history_id: id,
//           pad_count_0: cleanData[0].statuses.statuses
//             ? cleanData[0].statuses.statuses.pad_counts[0]
//             : null,
//           pad_count_1: cleanData[0].statuses.statuses
//             ? cleanData[0].statuses.statuses.pad_counts[1]
//             : null,
//           pad_count_2: cleanData[0].statuses.statuses
//             ? cleanData[0].statuses.statuses.pad_counts[2]
//             : null,
...
//         let current = {
//           history_id: id,
//           pad_seconds_0: cleanData[0].statuses.statuses
//             ? cleanData[0].statuses.statuses.pad_seconds[0]
//             : null,
//           pad_seconds_1: cleanData[0].statuses.statuses
//             ? cleanData[0].statuses.statuses.pad_seconds[1]
//             : null,
//           pad_seconds_2: cleanData[0].statuses.statuses
//             ? cleanData[0].statuses.statuses.pad_seconds[2]
//             : null,
